...
## v1.3.25 release (2026-07-12)

- `NexLink-WPF.ps1` — `\` bumped to `1.3.25`
- `NexLink-installer.iss` — `AppVersion` bumped to `1.3.25.0`
- `docs/index.html` — fallback versions bumped to `v1.3.25`
- `README.txt` — version bumped to `v1.3.25`
- SHA256 of installer: `7AD2DC044C803B9CC758458D557F3D0035EA5B8EDD827AE9B5299EBCA96A0658`
- Release notes: Bug fixes and improvements
---

## v1.3.26 release (2026-07-12)

- `NexLink-WPF.ps1` — `\` bumped to `1.3.26`
- `NexLink-installer.iss` — `AppVersion` bumped to `1.3.26.0`
- `docs/index.html` — fallback versions bumped to `v1.3.26`
- `README.txt` — version bumped to `v1.3.26`
- SHA256 of installer: `A71EE83EB375C5A6C0C548EEF2189C7AC76BB0AB20F7509D93863B9CF16874CA`
- Release notes: Bug fixes and improvements
---

## v1.3.27 release (2026-07-12)

- `NexLink-WPF.ps1` — `\` bumped to `1.3.27`
- `NexLink-installer.iss` — `AppVersion` bumped to `1.3.27.0`
- `docs/index.html` — fallback versions bumped to `v1.3.27`
- `README.txt` — version bumped to `v1.3.27`
- SHA256 of installer: `3CA74EA0882F28E7C2FF9FE221C2C47C6DAF26BCC12562C719715C1F2938DBA2`
- Release notes: Bug fixes and improvements
---

## v1.3.28 release (2026-07-12)

- `NexLink-WPF.ps1` — `\` bumped to `1.3.28`
- `NexLink-installer.iss` — `AppVersion` bumped to `1.3.28.0`
- `docs/index.html` — fallback versions bumped to `v1.3.28`
- `README.txt` — version bumped to `v1.3.28`
- SHA256 of installer: `9ADC5EDD145C10C8B319CE3A117326D4F1A5BD1FE110920444E86336BA30000D`
- Release notes: Bug fixes and improvements
---

## v1.3.29 release (2026-07-12)

- `NexLink-WPF.ps1` — `\` bumped to `1.3.29`
- `NexLink-installer.iss` — `AppVersion` bumped to `1.3.29.0`
- `docs/index.html` — fallback versions bumped to `v1.3.29`
- `README.txt` — version bumped to `v1.3.29`
- SHA256 of installer: `980A5259E30B2FE1282D41574CB7A3B23F310DC98F2F06FC6EE01B5E632D8D1C`
- Release notes: Bug fixes and improvements
---

## v1.3.31 release (2026-07-13)

- `NexLink-WPF.ps1` — `\` bumped to `1.3.31`
- `NexLink-installer.iss` — `AppVersion` bumped to `1.3.31.0`
- `docs/index.html` — fallback versions bumped to `v1.3.31`
- `README.txt` — version bumped to `v1.3.31`
- SHA256 of installer: `918463D84B81FA5D818A1FDF50977FD92BB235C432E42616917A07C622C22E1E`
- Release notes: Bug fixes and improvements
---

## v1.3.32 release (2026-07-13)

- `NexLink-WPF.ps1` — `\` bumped to `1.3.32`
- `NexLink-installer.iss` — `AppVersion` bumped to `1.3.32.0`
- `docs/index.html` — fallback versions bumped to `v1.3.32`
- `README.txt` — version bumped to `v1.3.32`
- SHA256 of installer: `50130155170DDBC61AFE9DB8703CE948C000D85C576BFA1D6E38F4BF2325C02D`
- Release notes: Bug fixes and improvements
---

## v1.3.33 release (2026-07-13)

- `NexLink-WPF.ps1` — `\` bumped to `1.3.33`
- `NexLink-installer.iss` — `AppVersion` bumped to `1.3.33.0`
- `docs/index.html` — fallback versions bumped to `v1.3.33`
- `README.txt` — version bumped to `v1.3.33`
- SHA256 of installer: `7A0330BFAB8FE28D3D8ED813B6C1D25854590BD5B38274D985B62FFF11E88E9C`
- Release notes: Bug fixes and improvements
---

## v1.3.34 release (2026-07-14)

- `NexLink-WPF.ps1` — `\` bumped to `1.3.34`
- `NexLink-installer.iss` — `AppVersion` bumped to `1.3.34.0`
- `docs/index.html` — fallback versions bumped to `v1.3.34`
- `README.txt` — version bumped to `v1.3.34`
- SHA256 of installer: `153953B36A2F3DC86A98F73C0017AED48376DF21A416CCEC8C5BA4B0F6D6B1CB`
