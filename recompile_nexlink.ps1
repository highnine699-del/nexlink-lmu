# ============================================================
# DEPRECATED - superseded by recompile_wpf.ps1 and release.ps1
# This script references the old NexLink-GUI.ps1 which has been
...
Invoke-ps2exe -inputFile '.\NexLink-GUI.ps1' -outputFile '.\NexLink.exe' -noConsole -requireAdmin -icon '.\wifi_icon.ico' -title 'NexLink' -version '1.2.0.0'
